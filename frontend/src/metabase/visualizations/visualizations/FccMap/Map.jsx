...
import PinMap from "../../components/FccPolygonMap/PinMap";
...
export class FccMap extends Component {
  static uiName = t`FCC Map`;
  static identifier = "fccmap";
  static iconName = "pinmap";

  static aliases = ["fcc_state", "fcc_country", "fcc_pin_map"];

  static minSize = getMinSize("fccmap");
  static defaultSize = getDefaultSize("fccmap");
